...
const enablePullRandom = () => {
  ...
  const pullIcon = `
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M13 5.5a2 2 0 1 0-4 0 2 2 0 0 0 4 0z"/>
      <path d="M9.5 13.5 7 21h2l1.7-4.3 2.3 1.4 2.2 3.9H18l-2.4-5.1-3.4-2.1 1.2-2.5 2.4 1.4h3.2v-2h-2.7l-3.3-1.8-1.6-2.1c-.4-.6-1.2-.8-1.9-.5l-2.3 1c-.6.3-.9 1-.7 1.7l.8 3.1 3.2 1.9-1 2.2-2.4-1.4z"/>
    </svg>
  `;
  const closeIcon = `
    <svg viewBox="0 0 24 24" aria-hidden="true">
